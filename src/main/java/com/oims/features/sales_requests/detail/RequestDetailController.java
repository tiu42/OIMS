...
public class RequestDetailController {
    ...
    public RequestDetailController(ISalesRequestDao salesRequestDao, IUserDao userDao, ISalesRequestItemDao salesRequestItemDao, IMerchandiseDao merchandiseDao) {
